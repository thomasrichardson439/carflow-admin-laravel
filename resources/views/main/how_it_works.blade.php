            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 col-10 offset-1">
                    ...
                    <div class="step">
                        ...
                        <p class="text-muted small">Important: Keep the documents you receive back from Car Flow with you while you are driving Car Flow vehicles.</p>
                    </div>
                    ...
                    <div class="step">
                        ...
                        <p>Use the Car Flow app to quickly communicate any problems to Car Flow. We won’t leave you hanging.</p>
                    </div>

                    <div class="step">
                        <h4>6. Return your car</h4>
                        <p>When your time is up, return the car to any Car Flow parking zone, put the keys back in the console and lock the car.</p>
