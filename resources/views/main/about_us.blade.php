        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 order-2 order-md-1">
                    ...
                    <p class="mt-4">
                        Car Flow co-founders Kyle Freedman and Carl Nowicki apply their backgrounds in business and education that to create a new approach to rideshare driving that puts control, flexibility and profits back into the hands of those who do power the industry – the drivers and car owners.
                </div>
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3 col-10 offset-1">
                    ...
                    <div class="step">
                        ...
                        <p>The result is Car Flow, where rideshare drivers can easily rent quality cars for as many or as few hours as they need and where car owners can rent their vehicles to qualified rideshare drivers whenever their cars would otherwise sit idle.
                            In the end, we believe that the Car Flow system will even lessen demand for for-hire vehicles in the city and decrease the congestion that plagues us all.</p>
                        <p>Everyone wins with Car Flow.</p>
                    </div>
