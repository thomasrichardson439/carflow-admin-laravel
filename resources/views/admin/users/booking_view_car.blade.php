                                ...
                                <div class="form-group" style="display: flex;">
                                    <div style="flex: 1;margin-top: 20px;">
                                        <input class="apple-switch mR-10"
                                               type="checkbox" name="is_recurring"
                                               value="1"
...
<script type="text/javascript">
    ...
    function update_time(str){
        var html = "";
        var rows = generateTimeSlots(str);
    ...
    $(document).ready(function () {
        ...
        $("#start_date").on("dp.change", function (e) {
            ...
            $("#start_time").html(update_time("00"));
...
//            $('#end_date').data("DateTimePicker").date(e.date);
//            $('#end_time').attr("disabled", false);
//            $("#end_time").html(update_time("59"));
