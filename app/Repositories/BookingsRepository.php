    ...
    public function endRide(Booking $booking, array $data) : array
    {
        \DB::transaction(function() use ($booking, $data) {
            ...
            if($booking->is_recurring){
                ...
                $newBooking->booking_starting_at = Carbon::parse($booking->booking_starting_at)->addWeek();
                $newBooking->booking_ending_at = Carbon::parse($booking->booking_ending_at)->addWeek();
